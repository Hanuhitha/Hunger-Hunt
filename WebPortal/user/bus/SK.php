...
$sql = "SELECT * FROM `SK`where seat_no LIKE'A%' ";
...
$sql1 = "SELECT * FROM `SK`where seat_no LIKE'B%' ";
...
$conn=mysqli_connect("localhost","root","","reservation");
$sql2 = "SELECT * FROM `SK`where seat_no LIKE'C%' ";
...
$conn=mysqli_connect("localhost","root","","reservation");
$sql3 = "SELECT * FROM `SK`where seat_no LIKE'D%' ";
...
$conn=mysqli_connect("localhost","root","","reservation");
$sql3 = "SELECT * FROM `SK`where seat_no LIKE'E%' ";
$result3 = mysqli_query($conn, $sql3)or die('wrong');
...
$query="update SK set name ='$n',age =$age,gender='$gender',status=1 where seat_no='$kk'";
