...
$sql = "SELECT * FROM `KPN`where seat_no LIKE'A%' ";
...
$sql1 = "SELECT * FROM `KPN`where seat_no LIKE'B%' ";
...
$conn=mysqli_connect("localhost","root","","reservation");
$sql2 = "SELECT * FROM `KPN`where seat_no LIKE'C%' ";
...
$conn=mysqli_connect("localhost","root","","reservation");
$sql3 = "SELECT * FROM `KPN`where seat_no LIKE'D%' ";
...
$query="update KPN set name ='$n',age =$age,gender='$gender',status=1 where seat_no='$kk'";
