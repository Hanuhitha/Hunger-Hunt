...
break;
        ...
        <li><a href="logout.php">Logout</a></li><?php echo $r['username'];?>
		...
		?>		
        <li><a data-hover="signin" href="signup.php">signin</a></li><li><a data-hover="Login" href="#log_in" class="scroll">Login</a></li>
