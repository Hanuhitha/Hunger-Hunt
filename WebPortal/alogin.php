 ...
 <li><a href="alogin.php"><span class="glyphicon glyphicon-user"></span>Admin Login</a></li>
  ...
  <div class="container-fluid">
	...
	<div class="banner-bottom">
		...
		<form method="post" action="admin/adminlogin.php" enctype="multipart/form-data" name="myForm" onsubmit="return(validate());">
	...
	<Tr>
		<Td colspan="2"></Td>
				...
				<tr>
					<td>Password</td>
					<Td><input type="password"  class="form-control" name="e" required/></td>
				</tr>
